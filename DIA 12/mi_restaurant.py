...
def total():
    ...
    texto_impuesto = sub_total * 0.07
    total = sub_total + texto_impuesto

    var_costo_comida.set(f'${round(sub_total_comida, 2)}')
    var_costo_bebida.set(f'${round(sub_total_bebida, 2)}')
    var_costo_postre.set(f'${round(sub_total_postres, 2)}')
    var_subtotal.set(f'${round(sub_total, 2)}')
    var_impuesto.set(f'${round(texto_impuesto, 2)}')  # ✅ corregido
...
def recibo():
    ...
    texto_recibo.insert(END, f'-' * 54 + '\n')
    texto_recibo.insert(END, 'Lo esperamos pronto muchas gracias')
...
# lista de productos
lista_comidas = ['pollo', 'cordero', 'salmon', 'lomo vetado', 'pastel de jaiva','papas','pizza','pizza3']
lista_bebidas = ['agua', 'cerveza', 'vino', 'jugo','jugo2', 'cerveza 1', 'cerveza 2','cerveza 3']
lista_postres = ['helados', 'tres leches','pastel', 'leche asada','pastel 1','pastel 2','pastel3','pastel4']
...
# etiquetas de consto y campos de entrada
...
for i in range(5):  # 5 filas (visor + 4 filas de botones)
    panel_calculadora.grid_rowconfigure(i, weight=1)
